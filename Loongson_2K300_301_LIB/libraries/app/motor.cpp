...
constexpr uint32_t kMotorPwmFreqHz = 17000;
// 电机初始化默认PWM占空比
constexpr int kDefaultInitDuty = 1200;
// 左电机前进时，方向GPIO输出电平
...
// 两轮速度差误差（初始值0）// 转向PID比例系数（巡线最优初始值：10.242f）
// float Diff_Kp = 15.0f;
// // 转向PID微分系数（巡线最优初始值：10.274f）
// float Diff_Kd = 12.274f;
